   ...
   if(window.location.search) {
     ...
     if(window.location.hash){
      ...
      $.ajax({
           ...
           dataType:'xml',
           url:'http://kinnective.com/kinnective4/fullway30e.php',
           data:{
                  command:47
           },
         ...
         //createAlertBox("signout function fires");
            ...
            if(user_first_name != "" && user_last_name != "" && useremail != "" && userid != "" && password1 != "" && password2 != ""){
               $.ajax({
                  ...
                  contentType: 'application/x-www-form-urlencoded',
                  dataType:'xml',
                  url:'http://kinnective.com/kinnective4/free_verify.php',
                  data:{
         ...
         //createAlertBox("signout function fires");
            ...
            if(user_first_name != "" && user_last_name != "" && useremail != "" && userid != "" && password1 != "" && password2 != ""){
               $.ajax({
                  ...
                  contentType: 'application/x-www-form-urlencoded',
                  dataType:'xml',
                  url:'http://kinnective.com/kinnective4/paid_verify.php',
                  data:{
                        user_first_name:user_first_name,
                        user_last_name:user_last_name,
                        userid:userid,
...
function renderCopiesView(){
  ...
  kinn.frameLoaded=function(){
   ...
   function refreshKinnreg4(){
               ...
               contentType: 'application/x-www-form-urlencoded',
               dataType:'html',
               url:'http://kinnective.com/kinnreg4bbb.html',
               success: function(data) {
                  var k4=data;
                  $('#kinnreg4').html(k4);
   ...
   kinn.captchaSubmit4=function captchaSubmit4(e){
      ...
      function refreshKinnreg3(){
               ...
               contentType: 'application/x-www-form-urlencoded',
               dataType:'html',
               url:'http://kinnective.com/kinnreg3bb.html',
               success: function(data) {
                  var k3=data;
                  $('#kinnreg3').html(k3);
